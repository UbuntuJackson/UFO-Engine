...
void
GraphicsEnginePGE::DrawDecal(AssetManager& _asset_manager,const std::string& _key, Vector2f _drawing_position, Vector2f _centre, Vector2f _source_position, Vector2f _source_size, Vector2f _scale, float _rotation, Colour _tint){
...
void
GraphicsEnginePGE::DrawFrame(AssetManager& _asset_manager,const std::string& _key, Vector2f _drawing_position, Vector2f _centre, Vector2f _frame_size, Vector2f _scale, int _index, float _rotation, Colour _tint){
    ufo::Rectangle sample_rectangle = _asset_manager.GetFrameFromSpriteSheet(_key, _index, _frame_size);
    
    graphics_engine->DrawPartialRotatedDecal(
        _drawing_position,
        _asset_manager.GetDecal(_key),
        _rotation,
        _centre,
